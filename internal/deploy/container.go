...
// GetContainer retrieves container deployment information
func (c *ContainerService) GetContainer(ctx context.Context, id, namespace string) (*models.DeploymentResponse, error) {
	logger := c.logger.Named("container_service").With(zap.String("deployment_id", id))
	...
	deployment := &appsv1.Deployment{
		...
		Spec: appsv1.DeploymentSpec{
			...
			Selector: &metav1.LabelSelector{
				MatchLabels: map[string]string{"app": name, "app-id": id},
			},
			Template: corev1.PodTemplateSpec{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{"app": name, "app-id": id},
				},
				Spec: corev1.PodSpec{
...
func (c *ContainerService) createService(ctx context.Context, name, namespace string, spec *models.ContainerSpec, labels map[string]string, id string) error {
	...
	service := &corev1.Service{
		...
		Spec: corev1.ServiceSpec{
			Selector: map[string]string{"app": name, "app-id": id},
			Ports:    servicePorts,
